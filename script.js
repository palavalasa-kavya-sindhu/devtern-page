document.addEventListener("DOMContentLoaded", function () {
    ...
    const forgotPasswordLink = document.querySelector('.l6');
    ...
    const validateInputs = () => {
        ...
        const testUsername = form.getAttribute('data-username-value');
        const testPassword = form.getAttribute('data-password-value');
